...
SYSTEM_PROMPT = (
    "You are a bullish oil market analyst specializing in Brent crude.\n"
    "Your job is to find and present the strongest arguments FOR a price increase.\n"
    "Be specific. Reference the data provided. Do not mention bearish factors.\n"
...
async def bullish_agent(state: AgentState, cfg: PipelineConfig) -> AgentState:
    """Generate the bullish analyst report."""
    ...
    try:
        ...
        return {"bullish_report": content.strip()}
    except Exception as exc:  # pragma: no cover - network/provider dependent
        return {
            "bullish_report": "Unable to generate bullish report.",
            "error": str(exc),
        }
